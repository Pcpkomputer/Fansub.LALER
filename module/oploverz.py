...
def oploverz(x):
	...
	zippy_regex=re.compile(r"<a href=\"(https://94lauin.com/.....)\" rel=\"noopener\" target=\"_blank\">Zippyshare")
	mirror_regex=re.compile(r"<a href=\"(https://94lauin.com/.....)\" rel=\"noopener\" target=\"_blank\">Mirror")
